...
function bubbleSort(array){
    ...
    for (var i = 0; i < end; i++){
      if (array[i] > array[i+1]){
        //switch the values using a generic swap function - 
        // found on Stack Overflow at: https://stackoverflow.com/questions/12358207/javascript-change-place-of-array-element 
      swap(array, i, i + 1);
      }
    }
  end--;
...
function swap(theArray, indexA, indexB) {
